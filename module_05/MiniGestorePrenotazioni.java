...
public class MiniGestorePrenotazioni {
    ...
    public int getTotalePostiOccupati() {
        return postiOccupati(prenotazioniInterno) + postiOccupati(prenotazioniEsterno);
    }
    ...
    public static void main(String[] args) {
        ...
        int postiTotali = miniGestorePrenotazioni.getTotalePostiOccupati();
        ...
        postiTotali = miniGestorePrenotazioni.getTotalePostiOccupati();
        System.out.println(postiTotali == 7);

        miniGestorePrenotazioni.terminaPrenotazione(p6);
        //verifichiamo di nuovo i posti effettivamente riservati
        postiTotali = miniGestorePrenotazioni.getTotalePostiOccupati();
        System.out.println(postiTotali == 6);
    }
